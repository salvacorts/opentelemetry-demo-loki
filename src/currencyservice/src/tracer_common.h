...
void initTracer()
{
  // Set the global trace provider to NoopTracerProvider
  auto noop_tracer_provider = nostd::shared_ptr<opentelemetry::trace::NoopTracerProvider>(new opentelemetry::trace::NoopTracerProvider());
  opentelemetry::trace::Provider::SetTracerProvider(std::move(noop_tracer_provider));

  // Set global propagator to Noop
